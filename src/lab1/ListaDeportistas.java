...
Lab1.c.mostrarListaD();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LISTA DE DEPORTISTAS");
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaDeportistas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaDeportistas().setVisible(true);
            }
        });
    }
