...
public class NuevoDeportista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField6.setText("Cantidad de días a la semana, ej: 5");

        jLabel9.setText("Frecuencia de entrenamiento");

        jTextField7.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        jTextField7.setForeground(new java.awt.Color(102, 102, 102));
        jTextField7.setText("Ej: 120");

        jLabel10.setText("Ritmo cardíaco (PPM)");

        jLabel11.setText("Tipo de ejercicio");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tonificación", "Reducción de Peso", "Reducción de Medidas", "Cardio", "Pesas", "Flexibilidad", "Relajación" }));
...
//para obtener los textfields
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoDeportista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoDeportista().setVisible(true);
            }
        });
    }
